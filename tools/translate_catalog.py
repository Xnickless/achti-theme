...
COLLECTIONS = {
 'en': {'kolekcja-damska': ('Women', "Achti women's winter hats: classic shapes and seasonal patterns, high-quality workmanship, made in Poland."),
        'kolekcja-meska': ('Men', "Men's winter hats: classic shapes, muted colours and durable knit for cold days."),
        'kolekcja-dla-dzieci': ('Kids', "Children's winter hats in sizes 50–52 and 52–54: warm, soft and comfortable, in colourful patterns."),
        'kolekcja-premium': ('Premium Merino', 'Merino wool hats, 100% merino or blended with acrylic: light, breathable and exceptionally warm.'),
        'private-label': ('Private Label', 'Hat production under your own brand: woven labels, tags, embroidery and custom colours. Configure a model below.'),
 ...
 'fr': {'kolekcja-damska': ('Femme', "Bonnets d'hiver femme Achti : coupes classiques et motifs de saison, finitions soignées, fabriqués en Pologne."),
        'kolekcja-meska': ('Homme', "Bonnets d'hiver homme : coupes classiques, couleurs sobres et maille résistante pour les jours froids."),
        'kolekcja-dla-dzieci': ('Enfant', "Bonnets d'hiver enfant en tailles 50–52 et 52–54 : chauds, doux et confortables, aux motifs colorés."),
        'kolekcja-premium': ('Premium Mérinos', 'Bonnets en laine mérinos, 100 % mérinos ou mélangée à l’acrylique : légers, respirants et très chauds.'),
        'private-label': ('Private Label', 'Production de bonnets sous votre marque : étiquettes tissées, broderies et couleurs personnalisées. Configurez un modèle ci-dessous.'),
 ...
 'de': {'kolekcja-damska': ('Damen', 'Damen-Wintermützen von Achti: klassische Formen und Saisonmuster, hochwertige Verarbeitung, hergestellt in Polen.'),
        'kolekcja-meska': ('Herren', 'Herren-Wintermützen: klassische Formen, gedeckte Farben und strapazierfähiger Strick für kalte Tage.'),
        'kolekcja-dla-dzieci': ('Kinder', 'Kinder-Wintermützen in den Größen 50–52 und 52–54: warm, weich und bequem, in bunten Mustern.'),
        'kolekcja-premium': ('Premium Merino', 'Mützen aus Merinowolle, 100 % Merino oder mit Acryl gemischt: leicht, atmungsaktiv und besonders warm.'),
        'private-label': ('Private Label', 'Mützenproduktion unter Ihrer Marke: Webetiketten, Anhänger, Stickerei und individuelle Farben. Konfigurieren Sie unten ein Modell.'),
