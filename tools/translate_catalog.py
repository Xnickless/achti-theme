...
THEME = {  # teksty z ustawień motywu (klucz = tekst PL)
 'en': {'Witamy na naszej platformie B2B': 'Welcome to our B2B platform', 'Inne kolory tego modelu': 'Other colours of this model', 'realizacja 7–14 dni roboczych': 'lead time 7–14 business days',
 ...
 'fr': {'Witamy na naszej platformie B2B': 'Bienvenue sur notre plateforme B2B', 'Inne kolory tego modelu': 'Autres couleurs de ce modèle', 'realizacja 7–14 dni roboczych': 'délai 7 à 14 jours ouvrés',
 ...
 'de': {'Witamy na naszej platformie B2B': 'Willkommen auf unserer B2B-Plattform', 'Inne kolory tego modelu': 'Weitere Farben dieses Modells', 'realizacja 7–14 dni roboczych': 'Lieferzeit 7–14 Werktage',
