...
THEME = {  # teksty z ustawień motywu (klucz = tekst PL)
 'en': { 
        ...
        "Blaszka": "Metal plate",
        "Metalowa blaszka z logo Twojej firmy, mocowana na wywinięciu lub z boku czapki.": "A metal plate with your company logo, fixed on the cuff or the side of the hat.",
        "Skórka": "Leather patch",
        "Skórzana naszywka z tłoczonym lub nadrukowanym logo, przyszywana do dzianiny.": "A leather patch with an embossed or printed logo, sewn onto the knit.",
        "Metka z logo firmy": "Label with your logo",
        "Czapka bez oznaczeń Achti, z Twoją metką wszywaną i zawieszką.": "A hat without Achti branding, with your sewn-in label and hang tag.","Zapisz się do newslettera i odbierz −15% na pierwsze zamówienie": "Join our newsletter and get −15% on your first order",
 ...
 'fr': { 
        ...
        "Blaszka": "Plaquette métal",
        "Metalowa blaszka z logo Twojej firmy, mocowana na wywinięciu lub z boku czapki.": "Plaquette en métal avec le logo de votre entreprise, fixée sur le revers ou le côté du bonnet.",
        "Skórka": "Écusson cuir",
        "Skórzana naszywka z tłoczonym lub nadrukowanym logo, przyszywana do dzianiny.": "Écusson en cuir avec logo embossé ou imprimé, cousu sur la maille.",
        "Metka z logo firmy": "Étiquette à votre logo",
        "Czapka bez oznaczeń Achti, z Twoją metką wszywaną i zawieszką.": "Bonnet sans marquage Achti, avec votre étiquette cousue et votre étiquette volante.","Zapisz się do newslettera i odbierz −15% na pierwsze zamówienie": "Inscrivez-vous à la newsletter et recevez −15 % sur votre première commande",
 ...
 'de': { 
        ...
        "Blaszka": "Metallplakette",
        "Metalowa blaszka z logo Twojej firmy, mocowana na wywinięciu lub z boku czapki.": "Metallplakette mit Ihrem Firmenlogo, am Umschlag oder seitlich an der Mütze befestigt.",
        "Skórka": "Lederpatch",
        "Skórzana naszywka z tłoczonym lub nadrukowanym logo, przyszywana do dzianiny.": "Lederpatch mit geprägtem oder bedrucktem Logo, auf den Strick aufgenäht.",
        "Metka z logo firmy": "Etikett mit Ihrem Logo",
        "Czapka bez oznaczeń Achti, z Twoją metką wszywaną i zawieszką.": "Mütze ohne Achti-Kennzeichnung, mit Ihrem eingenähten Etikett und Anhänger.","Zapisz się do newslettera i odbierz −15% na pierwsze zamówienie": "Newsletter abonnieren und −15 % auf die erste Bestellung sichern",
